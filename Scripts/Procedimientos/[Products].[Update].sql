...
AS 
BEGIN	
	UPDATE Products  SET Name= @Name, Description = @Description, Price = @Price, Current_Stock = @Current_Stock, Max_Stock = @Max_Stock, Min_Stock = @Min_Stock, Image_Path = @Image_Path WHERE id = @ID
END
GO
