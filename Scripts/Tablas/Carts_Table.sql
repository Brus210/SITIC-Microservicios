...
BEGIN
  EXEC sys.sp_updateextendedproperty 'MS_Description', 'Esta tabla almacena los diferentes carritos dados de alta en el sistema', 'SCHEMA', 'dbo', 'table', 'Carts'
END 
ELSE
BEGIN
  EXEC sys.sp_addextendedproperty 'MS_Description', 'Esta tabla almacena los diferentes carritos dados de alta en el sistema', 'SCHEMA', 'dbo', 'table', 'Carts'
END
GO
