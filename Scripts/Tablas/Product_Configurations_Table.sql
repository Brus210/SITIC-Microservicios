...
BEGIN
	/* Create Tables */
	--Define las configuraciones especificas para los producto, como diferentes colores y tamaños
	...
	(
		...
		[Configuration_Name] VARCHAR(255) NOT NULL,						--Nombre  la configuracion como puede ser: Color, Tamaño
...
BEGIN
  EXEC sys.sp_updateextendedproperty 'MS_Description', 'Define las configuraciones especificas para los producto, como diferentes colores y tamaños', 'SCHEMA', 'dbo', 'table', 'Product_Configurations'
END 
ELSE
BEGIN
  EXEC sys.sp_addextendedproperty 'MS_Description', 'Define las configuraciones especificas para los producto, como diferentes colores y tamaños', 'SCHEMA', 'dbo', 'table', 'Product_Configurations'
END
GO
